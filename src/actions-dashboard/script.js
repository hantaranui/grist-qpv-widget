    ...
    if (SEARCHABLE_FILTERS.has(key)) {
      return `<div class="filter-field">
        ...
        <details class="filter-search-dropdown">
          <summary class="form-control" aria-labelledby="filter-${key}-label"><span>${escapeHtml(selected || 'Toutes / Tous')}</span><span class="icon icon-chevron-up-down" aria-hidden="true"></span></summary>
